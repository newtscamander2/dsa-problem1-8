...
From \textcite{SupplementaryADS} \textbf{Theorem 6} any comparison among (first) $2^k$ elements requires at least $\lceil\log_2{(n+1)}\rceil$ where $n = 2^{k-1}$.
We know from phase one that $k = \lceil \log_2{d}\rceil$, and therefore $n = 2^{\lceil \log_2{d}\rceil-1}$
