...
\section*{Comment}
	To find a number in an infinitly long list, we search using binary search. But we don't know the upper bound, and we don't want to search the whole lower bound.
