...
To locate $d$ we use two phases:
First doubling then binary search in the found interval.



\subsection*{Phase 1: Doubling}
Because the sequence is infinitly long, we must first use a doubling phase as binary search requires us to have an interval.

We can express our sequence in the power of 2: $2^k$.
...
$3,5, 7, 9, 11, 17, 19, 23, 31, 33, 37, ...$ and $y = 11$ we have $d = 5$
...
\begin{center}
	\begin{minipage}{8.8cm}
		\begin{algorithmic}
			\Procedure{FindSearchInterval}{$A[x_1,x_2,x_3,..., x_{\infty}], x$}
...
\subsection*{Phase 1: Binary search}


\section*{Efficient solution}

Try $2^d$ in the first phase.
