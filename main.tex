...
\section*{Comment}
	To find a number at index $d$ in an infinitely long list, we search using binary search. But we don't know the upper bound, and we don't want to search the whole lower bound.
